...
# Launcher motor speed control PS4 SHARE and OPTION buttons 'select' and 'start'
                ...
                with ControllerResource() as joystick:
                    ...
                    while joystick.connected:
                        ...
                        if presses.start:
                            ...
                            #start_launcher_motors(launcher_on, launcher_speed)


                            # Need to add some error checking here to prevent firing if motors are nut turning?


                        # print("launcher speed = ", launcher_speed.value)
